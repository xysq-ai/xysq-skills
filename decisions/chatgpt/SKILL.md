---
name: decisions
description: "Extract choices and calls in a time window: what did we decide, why did we pick X, what was resolved. Pick over recap when the focus is the choices and rationale, not general progress."
---
