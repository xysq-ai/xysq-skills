# xysq Memory Protocol for Gemini CLI

This skill connects Gemini CLI to xysq persistent memory via MCP. The whole surface is four tools: userinfo, pull_context, push_context, share_context.
