---
name: actionables
description: "Surface open tasks and priorities: what do I need to do, what is on my plate, my open items. Forward work the user owns. Pick over recap (the past) and blockers (items stuck on someone else)."
---
