...
This file configures how your AI agent interacts with xysq - a consent-first persistent memory layer. Add the content below to your agent's system prompt.

**Activate when:** user says "remember", "recall", "what did I say about", "save this", references past decisions or preferences, or starts a new session where context would help.
