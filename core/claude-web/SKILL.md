...
This skill connects Claude web (claude.ai) to xysq - a consent-first persistent memory layer. It eliminates context re-explaining across sessions. Pull user context at session start. Retain corrections and decisions immediately. Use memory_reflect to gather facts then synthesize yourself, memory_recall for raw facts.
...
memory_retain(
  ...
  context=None,         # describes the source: "Claude web session - DB selection for payments"
