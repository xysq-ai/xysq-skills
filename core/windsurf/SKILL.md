...
This skill connects Windsurf to xysq persistent memory. Pull user context at session start. Persist corrections and decisions immediately. Use reflect for synthesis questions, recall for raw fact retrieval.
