...
This skill connects GitHub Copilot CLI to xysq persistent memory via MCP. Pull user context at session start. Persist corrections and decisions immediately. Use reflect for synthesis questions, recall for raw fact retrieval.
