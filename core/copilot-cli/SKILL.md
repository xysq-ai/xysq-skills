...
This skill connects GitHub Copilot CLI to xysq persistent memory via MCP. Pull user context at session start. Persist corrections and decisions immediately. Use memory_reflect to gather facts across memory then synthesize yourself; use memory_recall for raw fact retrieval.
